...
export const riasecnrQuestionSets = [
  ...
  [
    ...
    { perfil: "I", texto: "Tenho facilidade em interpretar gráficos, tabelas e informações técnicas." },
    { perfil: "A", texto: "Me sinto realizado(a) ao criar algo original e diferente." },
    { perfil: "S", texto: "Me envolvo em atividades de grupo e colaboração." },
  ...
  [
    ...
    { perfil: "I", texto: "Gosto de investigar causas e consequências dos fatos." },
    { perfil: "A", texto: "Me sinto inspirado(a) em ambientes criativos e inovadores." },
    { perfil: "S", texto: "Sinto prazer em compartilhar conhecimento com outras pessoas." },
  ...
  [
    ...
    { perfil: "I", texto: "Tenho prazer em aprender através de experimentos e testes." },
    { perfil: "A", texto: "Me identifico com profissões ligadas às artes ou à comunicação visual." },
    { perfil: "S", texto: "Gosto de promover o bem-estar em grupos de convivência." },
  ...
  [
    ...
    { perfil: "I", texto: "Me interesso por pesquisas, análises e descobertas." },
    { perfil: "A", texto: "Tenho vontade de expressar minhas ideias por meio da arte." },
    { perfil: "S", texto: "Tenho facilidade para criar relações de confiança com as pessoas." },
  ...
  [
    ...
    { perfil: "I", texto: "Gosto de estudar fenómenos naturais ou científicos." },
    { perfil: "A", texto: "Me sinto motivado(a) ao participar de projetos criativos." },
    { perfil: "S", texto: "Tenho facilidade em lidar com pessoas de diferentes idades e origens." },
...
// Exemplo de uso: 
// para cada rodada (lista), percorre-se as perguntas, e para cada pergunta o aluno atribui uma nota de 0 a 10.
